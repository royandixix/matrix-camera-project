...
while True:
    ...
    if face_result.face_landmarks:
        for face in face_result.face_landmarks:
            ...
            draw_label(frame, "MATA", pts[33], (0,255,255))

            # Mulut luar
            for idx in [61, 291]:
                cv2.circle(frame, pts[idx], 6, (255,0,255), -1)
            draw_label(frame, "MULUT LUAR", pts[61], (255,0,255))

            # Mulut dalam / lidah
            for idx in [13,14]:
                cv2.circle(frame, pts[idx], 7, (0,0,255), -1)
            draw_label(frame, "MULUT DALAM", pts[13], (0,0,255))

            # Pipi
            cv2.circle(frame, pts[234], 7, (255,150,0), -1)
            cv2.circle(frame, pts[454], 7, (255,150,0), -1)
            draw_label(frame, "PIPI KIRI", pts[234], (255,150,0))
            draw_label(frame, "PIPI KANAN", pts[454], (255,150,0))
